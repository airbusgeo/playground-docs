...
PROCESS_DATA = {
    ...
    "name": "eu.gcr.io/playground-doc/tile-change-detection-stub",
    "title": "Playground tile change detection stub",
    "family": "",
    "version": "1.0",
...
def jobs():
    ...
    try:
        ...
        zoom = int(data['zoom'])
        tile_1_format = data['tile1Format']
        tile_1 = base64.b64decode(data['tile1'])
        tile_2_format = data['tile2Format']
        tile_2 = base64.b64decode(data['tile2'])
        if 'mask' in data:
    ...
    try:
        # detect objects
        prediction = PREDICTOR.process(zoom, [tile_1_format, tile_2_format],
                                       [tile_1, tile_2], mask, debug)
